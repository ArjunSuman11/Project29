...
function setup(){
    ...
    sling=new SlingShot(sling.body,{x:200,y:500});
    //creating the blocks
    block2= new Box(250, 260, 20 ,40);
    block3 = new Box(300, 260, 20, 40);
    block4= new Box(400, 260, 20, 40);
    block5=new Box(200, 260, 40 , 50);
    block6= new Box(350, 260, 50 , 60);
    block7 =new Box(220, 210, 20 , 40);
    block8= new Box(270, 210, 20 , 40 );
}
function draw(){
    background(0);
    rectMode(CENTER);
